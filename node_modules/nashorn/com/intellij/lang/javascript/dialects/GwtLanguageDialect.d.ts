...
declare class GwtLanguageDialect {
	static DIALECT_OPTION_HOLDER : DialectOptionHolder;
	fileExtension : string;
	constructor();
}


declare interface GwtLanguageDialect extends JSLanguageDialect {}
export = GwtLanguageDialect
